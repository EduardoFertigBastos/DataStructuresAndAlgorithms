Program Pzim ;
  ...
  type
		...
		Begin		    
				...
				begin
						writeln;
						writeln ('Não tem nada para ser consultado na Deck!');
						writeln;
				end
				else
				begin
						...
						if (iOpcao = 1) then
						begin								
							  writeln ('O número encontrado foi: ', oDeck.pInicio^.iDado);
						end
						else
						begin
								writeln ('O número encontrado foi: ', oDeck.pFim^.iDado);								
						end;
						writeln;
				end;
				writeln('------------------------------');
		...
		Begin
		   ...
		   if (oDeck.pInicio = nil) then
		   begin
		   		writeln('Não tem nada pra imprimir na Deck!');
		   end   
		   else
		   Begin
		      pAux:= oDeck.pInicio;
